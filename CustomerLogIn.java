/**
 * Author: Ravi Tiwari
 * Filename: CustomerLogIn.java
 * Specifications: A Java file with JFrame which allows Customer to SignIn
...
public class CustomerLogIn extends JFrame {
	...
	private JButton addItemToTheCartButton = new JButton();
	...
	private static void viewFrame() {
		...
		frame.setDefaultCloseOperation(CustomerLogIn.EXIT_ON_CLOSE);
	...
	private void design() {
		...
		for(Items i : Items.itemsArray) {
			itemsCB.addItem(i.getName() + " | " + "$" + i.getPrice());
		}
		...
		addItemToTheCartButton.setFont(new Font("Arial", 1, 14)); 
		addItemToTheCartButton.setText("Add Item to the Cart");
		...
		addItemToTheCartButton.addActionListener (new ActionListener () {
			public void actionPerformed (ActionEvent e) {
								...
								if(Items.itemsArray.get(i).getName().equals(itemNameTF.getText().substring(0, itemNameLength-8).trim())) {
									...
									for(int j = 0; j < itemsInCart.size(); j++) {
										...
										if(itemName.trim().equals(itemsInCart.get(j).toString())) {
											...
											//itemsInCart.get(j).setQuantity(Integer.parseInt(itemsInCartList.getSelectedValue().toString().substring(itemsInCartList.getSelectedValue().toString().length() - 2)));
										}
									}
		...
		dltItemButton.addActionListener (new ActionListener () {
			public void actionPerformed (ActionEvent e) {
				if(itemsInCartList.getSelectedIndex() > -1) {
					...
					for(int i = 0; i < itemsInCart.size(); i++) {
						if(itemName.trim().equals(itemsInCart.get(i).getName())) { // delete item button logic
							try {
								c = DriverManager.getConnection("jdbc:postgresql://localhost:5432/users","postgres","123");
								c.setAutoCommit(false);
								stmt = c.createStatement();
								final String deleteQuery = "DELETE from cart where username = '" + 
										getCurrentUser() + "' AND itemname = '" + itemsInCart.get(i).getName() + "';"; 
								stmt.executeUpdate(deleteQuery);
								c.commit();
							}
							catch (Exception e1) {
		...
		GroupLayout layout = new GroupLayout(getContentPane()); //JFrame Logic
										...
										.addGroup(layout.createParallelGroup(GroupLayout.Alignment.LEADING)
												.addGroup(layout.createSequentialGroup()
														.addGroup(layout.createParallelGroup(GroupLayout.Alignment.LEADING)
																...
																.addComponent(dltItemButton, GroupLayout.Alignment.TRAILING, GroupLayout.PREFERRED_SIZE, 117, GroupLayout.PREFERRED_SIZE))
														.addGap(161, 161, 161)
														.addComponent(itemsCB, GroupLayout.PREFERRED_SIZE, 220, GroupLayout.PREFERRED_SIZE)
														.addGap(0, 0, Short.MAX_VALUE))
												.addGroup(layout.createSequentialGroup()
														.addGroup(layout.createParallelGroup(GroupLayout.Alignment.LEADING)
																.addGroup(layout.createSequentialGroup()
																...
																.addGroup(GroupLayout.Alignment.TRAILING, layout.createSequentialGroup()
																		.addGroup(layout.createParallelGroup(GroupLayout.Alignment.TRAILING)
																				...
																				.addComponent(placeOrderButton, GroupLayout.DEFAULT_SIZE, 117, Short.MAX_VALUE))
																		.addGap(146, 146, 146)
																		.addComponent(addItemToTheCartButton, GroupLayout.PREFERRED_SIZE, 181, GroupLayout.PREFERRED_SIZE)
																		.addGap(142, 142, 142))
																.addGroup(GroupLayout.Alignment.TRAILING, layout.createSequentialGroup()
																		.addGap(0, 0, Short.MAX_VALUE)
																		.addGroup(layout.createParallelGroup(GroupLayout.Alignment.LEADING)
																				.addComponent(itemNameLabel)
																				.addComponent(quantLabel, GroupLayout.PREFERRED_SIZE, 72, GroupLayout.PREFERRED_SIZE))
																		.addGap(58, 58, 58)
																		.addGroup(layout.createParallelGroup(GroupLayout.Alignment.LEADING)
																				.addComponent(itemNameTF, GroupLayout.PREFERRED_SIZE, 120, GroupLayout.PREFERRED_SIZE)
																				.addComponent(quantTF, GroupLayout.PREFERRED_SIZE, 120, GroupLayout.PREFERRED_SIZE))
																		.addGap(88, 88, 88)))
				...
				.addGroup(layout.createSequentialGroup()
						...
						.addGroup(layout.createParallelGroup(GroupLayout.Alignment.LEADING)
								...
								.addGroup(layout.createSequentialGroup()
										...
										.addGap(18, 18, 18)
										.addComponent(addItemToTheCartButton)))
