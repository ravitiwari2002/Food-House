/**
 * Author: Ravi Tiwari
 * Filename: EmployeeAddCustomer.java
 * Specifications: A Java file with JFrame where employee can SignUp on behalf of Customers
...
public class EmployeeAddCustomer extends JFrame {
	...
	private static void viewFrame() {
		...
		EmployeeAddCustomer frame = new EmployeeAddCustomer();
		frame.setTitle("Casino Coffee");
		frame.setLocationRelativeTo(null);
		frame.setVisible(true);
		frame.setDefaultCloseOperation(EmployeeAddCustomer.EXIT_ON_CLOSE);
	...
	private void design() {
		...
		addCustomerButton.addActionListener (new ActionListener () {
			public void actionPerformed (ActionEvent e) {
				...
				//check if phone number, username, and email address are unique
				else {
					try {
						c = DriverManager.getConnection("jdbc:postgresql://localhost:5432/users","postgres","123");
						stmt = c.createStatement();
					...
					//insert the data into database
						...
						try {
							...
							EmployeeAddedCustomerMessage f = new EmployeeAddedCustomerMessage();

							f.setResizable(false);
							f.setTitle("Casino Coffee");
							f.setLocationRelativeTo(null);
							f.setVisible(true);
							f.setDefaultCloseOperation(EmployeeAddedCustomerMessage.EXIT_ON_CLOSE);
							f.addWindowListener(new WindowAdapter()
							{
								@Override
								public void windowClosing(WindowEvent e)
		...
		//adding KeyListener and ActionListener to the components
