 ...
 * Specifications: A Java file with JFrame which allows manager to signIn
...
public class ManagerLogIn extends JFrame {
	...
	private static void viewFrame() {
		...
		frame.setDefaultCloseOperation(ManagerLogIn.EXIT_ON_CLOSE);
	...
	private void design() {
		...
		addCustomerButton.addActionListener (new ActionListener () {
			public void actionPerformed (ActionEvent e) {
				ManagerAddCustomer f = new ManagerAddCustomer();
				f.setResizable(false);
				f.setTitle("Casino Coffee");
				f.setDefaultCloseOperation(ManagerAddCustomer.EXIT_ON_CLOSE);
		...
		addEmployeeButton.setText("Add an Employee");
		addEmployeeButton.addActionListener (new ActionListener () {
			public void actionPerformed (ActionEvent e) {
				ManagerAddEmployee f = new ManagerAddEmployee();
				f.setResizable(false);
				f.setTitle("Casino Coffee");
				f.setDefaultCloseOperation(ManagerAddEmployee.EXIT_ON_CLOSE);
				f.addWindowListener(new WindowAdapter()
				{
					@Override
					public void windowClosing(WindowEvent e)
								...
								.addGroup(layout.createSequentialGroup()
										.addGroup(layout.createParallelGroup(GroupLayout.Alignment.TRAILING)
												...
												.addGroup(layout.createParallelGroup(GroupLayout.Alignment.LEADING, false)
														.addComponent(addEmployeeButton, GroupLayout.DEFAULT_SIZE, GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
